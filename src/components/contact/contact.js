...
import Resume from "../../assets/RenukaResume.docx"
const Contact = () => {
                    ...
                    <div className={styles.profile_card}>
                        ...
                        <div className={` mt-5 mb-5 justify-between lg:justify-evenly ` + styles.profile_card__connect}>
                            ...
                            <div>
                                ...
                                <ul>
                                    <li>
                                        <a href="https://www.linkedin.com/in/renuka-chowdary-70a45b1b1/" rel="noreferrer" target="_blank"><LinkedInIcon /></a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/Renuani181" rel="noreferrer" target="_blank"><GitHubIcon /></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div className={`text-center w-[100%]`}>
                            ...
                            <a className={`icon_link inline-block`} href="https://github.com/Renuani181" rel="noreferrer" target="_blank">  Check out the code here: <InsertLinkIcon /></a>
                        </div>
                    </div>
                </div>
            </div>
